 ...
 * metadata, `write` will be a function that takes metadata, and returns
 * a writable stream, to which the value should be piped (to allow writing new
 * content too on read if necessary).  Otherwise `isCacheHit` will be `false`,
 * `entry` will be `undefined`, and `write` will be available as before, e.g.:
 *
 * ```
